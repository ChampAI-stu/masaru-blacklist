...
(function () {
  ...
  const PLATFORMS = [
    { key: 'TikTok',   file: 'tiktok.html',   name: 'TikTok Shop', c1: '#111827', c2: '#FE2C55', ic: '🎵' },
    { key: 'Lazada',   file: 'lazada.html',   name: 'Lazada',      c1: '#0F146D', c2: '#F57224', ic: '🛒' },
    { key: 'Shopee',   file: 'shopee.html',   name: 'Shopee',      c1: '#B03A00', c2: '#EE4D2D', ic: '🧡' },
    { key: 'Facebook', file: 'facebook.html', name: 'Facebook',    c1: '#0B3C8D', c2: '#1877F2', ic: '📘' }
  ];
  ...
  window.BL = {
    ...
    PLATFORMS: PLATFORMS, platformOf: platformOf
  };
})();
